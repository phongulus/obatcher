module IntAvltree = Data.Avltree.Sequential(Int)
module IntAvltreePrebatch = Data.Avltree.Prebatch(Int)
module IntAvltreeSplitJoin = Data.Splitjoin.Make(IntAvltreePrebatch)
