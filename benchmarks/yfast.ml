...
module IntYfastTrie = Data.Yfast.Sequential
module IntYfastTriePrebatch = Data.Yfast.Prebatch
module IntYfastTrieFunctor = Data.Exposerepair.Make(IntYfastTriePrebatch)
