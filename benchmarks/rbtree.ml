module IntRbtree = Data.Rbtree.Sequential(Int)
module IntRbtreePrebatch = Data.Rbtree.Prebatch(Int)
module IntRbtreeSplitJoin = Data.Splitjoin.Make(IntRbtreePrebatch)
