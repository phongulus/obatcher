...
module IntVebTree = Data.Vebtree.Sequential
module IntVebTreePrebatch = Data.Vebtree.Prebatch
module IntVebTreeFunctor = Data.Exposerepair.Make(IntVebTreePrebatch)
